<!-- Put this file in the special repository named `Ayushi3571` to make it your GitHub profile README. -->
...
```txt
ayushi@github:~$ whoami
Computer Science + Math student
Interested in reinforcement learning, computer vision, and systems that can see + learn
...
<details>
<summary><strong>custom OCR system</strong> | feature control frame symbols</summary>
...
<details>
<summary><strong>precision agriculture</strong> | local nonprofit collaboration</summary>
...
<table>
  <tr>
    ...
    <td>Python, SQL, Node.js, R</td>
  </tr>
  <tr>
    <td><strong>interests</strong></td>
    <td>Reinforcement Learning, Computer Vision, OCR, Applied ML</td>
  </tr>
  <tr>
    <td><strong>vibe</strong></td>
    <td>part math brain, part builder, part "what happens if I train an agent on this?"</td>
  </tr>
</table>
